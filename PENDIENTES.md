...
- [ ] **E16 Capacitor con el backend real — solicitado el 8 de septiembre.** Preparar configuración pública verificable, comandos nativos y compilación Android/iOS en GitHub; generar un APK para iniciar sesión en el proyecto real. Comprobar los orígenes nativos contra la API. La firma de iPhone y las pruebas con la cuenta del usuario requieren su Mac/dispositivo o una sesión autorizada; no sustituirlas por datos de QA.
